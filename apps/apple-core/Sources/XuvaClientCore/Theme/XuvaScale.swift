...
public enum XuvaScale {
    ...
    /// Column count for the Movies / TV LibraryGrid. Looser than the web
    /// because a TV viewer is 2–3 m away and small posters become unreadable.
    /// 1920×1080 (Apple TV 4K logical) → 6 columns, leaving real breathing
    /// room between cards rather than the 4 pt-per-side squeeze 7 produced.
