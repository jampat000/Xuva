...
@MainActor
final class VyrdenAppState: ObservableObject {
    ...
    func pollPairing(client: VyrdenAPIClient, id: String) async {
    ...
    func loadHome(client: VyrdenAPIClient? = nil) async {
        do {
            let api: VyrdenAPIClient
            if let client {
                api = client
            } else {
                api = try VyrdenAPIClient(serverURL: serverURL)
            }
