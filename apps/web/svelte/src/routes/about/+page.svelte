...
<svelte:head>
  ...
  <meta name="description" content="About Xuva — your personal cinema, everywhere." />
</svelte:head>
  ...
  <main class="px-6 pb-32 pt-24 md:px-12 md:pt-28 lg:px-20">
    ...
    <div class="mx-auto max-w-2xl">
      ...
      <h1 class="font-serif-display text-[clamp(2rem,5vw,3.5rem)] leading-[1] tracking-tight">
        Your cinema, <em>everywhere.</em>
      </h1>
      <p class="mt-6 text-base leading-relaxed text-muted-foreground">
        Xuva is a personal media server designed for cinema lovers. Stream your collection on every screen you own — from a 77-inch OLED to a phone screen on the commute.
      </p>
