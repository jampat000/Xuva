<script lang="ts">
	...
	let {
		...
		meta = 'Setup',
		description = 'Choose a Movies or TV folder and Xuva will build your personal streaming home.',
		progress = 0,
		progressLabel = '',
		playHref = '',
		detailHref = ''
