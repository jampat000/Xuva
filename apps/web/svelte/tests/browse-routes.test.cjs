...
test('movies route uses real browse API and Xuva controls without product preview mode', () => {
...
test('tv route uses real browse API and Xuva controls without product preview mode', () => {
...
test('home route uses backend data and keeps media-first Xuva sections', () => {
	...
	assert.doesNotMatch(routeSource, /XuvaMediaHome/);
