...
test('settings route uses existing settings APIs and real user actions', () => {
	...
	assert.match(source, /updateMetadataSourcePreferences\(\s*\{\s*movie,\s*series,\s*movieArtwork,\s*seriesArtwork\s*\},\s*apiClient\s*\)/);
	...
	assert.match(source, /Metadata Experience/);
	...
	assert.match(source, /Prefer local artwork/);
	assert.match(source, /Advanced provider settings/);
	assert.match(source, /Advanced Provider Settings/);
	assert.match(source, /Movie metadata sources/);
	assert.match(source, /Movie artwork sources/);
	assert.match(source, /TV metadata sources/);
	assert.match(source, /TV artwork sources/);
	assert.match(source, /Save Metadata Preferences/);
	...
	assert.match(source, /Pick the level of control you want\. Most libraries should stay on Automatic\./);
	assert.match(source, /Enable at least one movie metadata source\./);
	assert.match(source, /Enable at least one movie artwork source\./);
	assert.match(source, /Enable at least one TV metadata source\./);
	assert.match(source, /Enable at least one TV artwork source\./);
	assert.match(source, /Metadata preferences saved\./);
	assert.match(source, /Provider availability is managed by Xuva in the backend\./);
	...
	assert.doesNotMatch(source, /tmdbApiKey/);
	assert.doesNotMatch(source, /tvdbApiKey/);
	assert.doesNotMatch(source, /fanartTvApiKey/);
	assert.doesNotMatch(source, /omdbApiKey/);
	assert.doesNotMatch(source, /Provider Setup/);
	assert.doesNotMatch(source, /Save Provider Keys/);
	assert.doesNotMatch(source, /Clear Key/);
	assert.doesNotMatch(source, /Key required/);
