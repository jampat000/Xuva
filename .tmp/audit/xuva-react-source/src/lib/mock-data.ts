export type Media = {
  ...
  progress?: number;
  synopsis: string;
  /** Portrait artwork (2:3). When present, replaces the gradient placeholder. */
  poster?: string;
  /** Landscape artwork (16:9) used for hero backdrops and wide cards. */
  backdrop?: string;
  /** Logo treatment artwork (transparent PNG of the title). Optional. */
  logo?: string;
...
export const continueWatching: Media[] = [
  { id: "and-the-band", title: "And the Band Played On", year: 1993, type: "Movie", genres: ["Drama", "History"], rating: 7.7, runtime: "2h 21m", progress: 0.09, synopsis: "", palette: ["#1e3a5f", "#6b2d5c"], accent: "#60a5fa" },
  { id: "quiet-place-2", title: "A Quiet Place Part II", year: 2021, type: "Movie", genres: ["Horror"], rating: 7.2, runtime: "1h 37m", progress: 0.01, synopsis: "", palette: ["#1a1f2e", "#5b1f1f"], accent: "#f87171" },
  { id: "civil-action", title: "A Civil Action", year: 1998, type: "Movie", genres: ["Drama"], rating: 6.6, runtime: "1h 55m", progress: 0.34, synopsis: "", palette: ["#2d1f4a", "#8b5cf6"], accent: "#a78bfa" },
  { id: "blade-runner-cw", title: "Blade Runner 2049", year: 2017, type: "Movie", genres: ["Sci-Fi"], rating: 8.0, runtime: "2h 44m", progress: 0.62, synopsis: "", palette: ["#7a3b1f", "#d97706"], accent: "#fb923c" },
  { id: "terminal-list", title: "The Terminal List", year: 2022, type: "Series", genres: ["Thriller"], rating: 8.0, seasons: 1, episodes: 8, progress: 0.45, synopsis: "", palette: ["#1e3a8a", "#0f172a"], accent: "#60a5fa" },
];
...
export const topTen: Media[] = [
  ...
  { id: "t6", title: "Shōgun", year: 2024, type: "Series", genres: ["Drama"], rating: 8.7, seasons: 1, episodes: 10, synopsis: "", palette: ["#3f0f0f", "#9b1c1c"], accent: "#fbbf24" },
...
export const recentMovies: Media[] = [
  ...
  { id: "m3", title: "12 Angry Men", year: 1957, type: "Movie", genres: ["Drama"], rating: 9.0, runtime: "1h 36m", synopsis: "", palette: ["#1f1f1f", "#dc2626"], accent: "#fbbf24" },
...
export const recentSeries: Media[] = [
  ...
  { id: "s2", title: "90 Day Fiancé", year: 2014, type: "Series", genres: ["Reality"], rating: 6.2, seasons: 11, episodes: 220, synopsis: "", palette: ["#831843", "#be185d"], accent: "#f472b6" },
  ...
  { id: "s4", title: "Shōgun", year: 2024, type: "Series", genres: ["Drama"], rating: 8.7, seasons: 1, episodes: 10, synopsis: "", palette: ["#3f0f0f", "#9b1c1c"], accent: "#fbbf24" },
  ...
  { id: "s8", title: "The Terminal List", year: 2022, type: "Series", genres: ["Action"], rating: 8.0, seasons: 1, episodes: 8, synopsis: "", palette: ["#1e3a8a", "#0f172a"], accent: "#60a5fa" },
];
