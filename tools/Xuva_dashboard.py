#!/usr/bin/env python3
"""Generate a local Xuva compatibility dashboard from scanner JSONL output."""
...
def render_dashboard(records: list[dict[str, Any]], source: Path) -> str:
    ...
    body = f"""
      <header>
        <div class="brand"><div class="mark">V</div><div><h1>Xuva Compatibility Dashboard</h1><p>Local library intelligence generated from <code>{generated}</code>.</p></div></div>
      </header>
...
<html lang="en">
  <head>
    ...
    <title>Xuva Compatibility Dashboard</title>
    <style>
      :root {{
        color-scheme: dark;
        --bg: #080705;
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a local Xuva compatibility dashboard.")
