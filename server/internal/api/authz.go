...
var routePolicies = map[string]routePolicy{
	...
	"GET /api/watchlist":                   route("GET /api/watchlist", "watchlist", "watchlist.list", roleAdmin, roleStandard),
	"POST /api/watchlist":                  route("POST /api/watchlist", "watchlist", "watchlist.add", roleAdmin, roleStandard),
	"DELETE /api/watchlist/{id}":           route("DELETE /api/watchlist/{id}", "watchlist", "watchlist.remove", roleAdmin, roleStandard),
