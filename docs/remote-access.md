...
Xuva should help users configure remote access, but it should not require Xuva-owned infrastructure.

The setup experience should be honest: Xuva can test, explain, and generate guidance, but the user controls the route.
...
Xuva should document and generate config examples for:
...
- Xuva must not imply that unsupported NAT or ISP setups are the user's fault.
