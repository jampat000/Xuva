...
The current lead direction for Xuva is the Movie Detail Concept.
...
- The playback forecast explains what Xuva will do before the user presses play.
...
- A stronger sense that Xuva has its own identity.
