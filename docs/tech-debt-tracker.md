...
| TD-002 | Desktop alpha | Native folder picker bridge is defined but no tray/taskbar shell exists. | Installed UX cannot yet use OS-native folder picker or Restart now. | Choose desktop shell and implement `window.vyrdenDesktop.pickFolder`. |
