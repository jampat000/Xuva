...
## Client And Release Tracks

- [Apple TV alpha](apple-tv-alpha.md)
...
- [Playback engine](playback-engine.md)
- [Playback decision v2](playback-decision-v2.md)
- [Adaptive streaming](adaptive-streaming.md)
- [Subtitle pipeline](subtitle-pipeline.md)
- [Transcode reliability](transcode-reliability.md)
- [Live playback inspector](live-playback-inspector.md)
...
- [TV experience](design/tv-experience.md)
- [Design tokens](design/design-tokens.md)

## Execution System

- [Agent harness](agent-harness.md)
- [Quality scorecard](quality-score.md)
- [Technical debt tracker](tech-debt-tracker.md)
- [Active plans](plans/active/)
- [Completed plans](plans/completed/)
- [Handover journal](handover-journal.md)

## Generated References

Generated references belong under `docs/generated/`. They should be reproducible from local scripts and should not become hand-edited source material unless promoted into normal docs.
